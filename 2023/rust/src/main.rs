...
fn main() {
    ...
    println!("");
    println!("day2.1 sample - {0}", day1_1(&get_input_sample("day2")));
    println!("day2.1        - {0}", day1_1(&get_input("day2")));
    println!("day2.2 sample - {0}", day1_2(&get_input_sample("day2")));
    println!("day2.2        - {0}", day1_2(&get_input("day2")));
    println!("");
}
